...
//-----------------------------------------------------------------------------
HRESULT CD3DFont::InitDeviceObjects( LPDIRECT3DDEVICE8 pd3dDevice, CDirect3DDeviceUtility *pd3dDeviceUtility)
{
    HRESULT hr;

    // Keep a local copy of the device
    m_pd3dDevice = pd3dDevice;
	m_pd3dDeviceUtility=pd3dDeviceUtility;
...
HRESULT CD3DFont::RestoreDeviceObjects()
{
    ...
    for( UINT which=0; which<2; which++ )
    {
        ...
        m_pd3dDeviceUtility->SetRenderState( D3DRS_ALPHATESTENABLE,  TRUE );
        m_pd3dDeviceUtility->SetRenderState( D3DRS_ALPHAREF,         0x08 );
        m_pd3dDeviceUtility->SetRenderState( D3DRS_ALPHAFUNC,  D3DCMP_GREATEREQUAL );
        ...
        m_pd3dDeviceUtility->SetRenderState( D3DRS_STENCILENABLE,    FALSE );
        m_pd3dDeviceUtility->SetRenderState( D3DRS_CLIPPING,         TRUE );
        m_pd3dDeviceUtility->SetRenderState( D3DRS_EDGEANTIALIAS,    FALSE );
        m_pd3dDeviceUtility->SetRenderState( D3DRS_CLIPPLANEENABLE,  FALSE );
        m_pd3dDeviceUtility->SetRenderState( D3DRS_VERTEXBLEND,      FALSE );
        m_pd3dDeviceUtility->SetRenderState( D3DRS_INDEXEDVERTEXBLENDENABLE, FALSE );
        m_pd3dDeviceUtility->SetRenderState( D3DRS_FOGENABLE,        FALSE );
        ...
        m_pd3dDeviceUtility->SetTextureStageState( 0, D3DTSS_ALPHAOP,   D3DTOP_MODULATE );
        m_pd3dDeviceUtility->SetTextureStageState( 0, D3DTSS_ALPHAARG1, D3DTA_TEXTURE );
        m_pd3dDeviceUtility->SetTextureStageState( 0, D3DTSS_ALPHAARG2, D3DTA_DIFFUSE );
        m_pd3dDeviceUtility->SetTextureStageState( 0, D3DTSS_MINFILTER, D3DTEXF_POINT );
        m_pd3dDeviceUtility->SetTextureStageState( 0, D3DTSS_MAGFILTER, D3DTEXF_POINT );
        m_pd3dDeviceUtility->SetTextureStageState( 0, D3DTSS_MIPFILTER, D3DTEXF_NONE );
        m_pd3dDeviceUtility->SetTextureStageState( 0, D3DTSS_TEXCOORDINDEX, 0 );
        m_pd3dDeviceUtility->SetTextureStageState( 0, D3DTSS_TEXTURETRANSFORMFLAGS, D3DTTFF_DISABLE );
        m_pd3dDeviceUtility->SetTextureStageState( 1, D3DTSS_COLOROP,   D3DTOP_DISABLE );
        m_pd3dDeviceUtility->SetTextureStageState( 1, D3DTSS_ALPHAOP,   D3DTOP_DISABLE );
...
HRESULT CD3DFont::Render3DText( TCHAR* strText, DWORD dwFlags )
{
    ...
    if( dwFlags & D3DFONT_TWOSIDED )
        m_pd3dDeviceUtility->SetRenderState( D3DRS_CULLMODE, D3DCULL_NONE );
